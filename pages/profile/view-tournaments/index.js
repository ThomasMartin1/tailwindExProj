    ...
    fetch(
      ...
      .then((data) => {
        ...
        for (const key in data) {
          const tournament = {
            id: key,
            href: `/profile/view-tournaments/${key}`,
            ...data[key],
          };
    ...
    <div>
      ...
      <main className="bg-gray-50">
        <div className="max-w-6xl mx-auto py-16 px-4">
          ...
          <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 md:grid-cols-2 lg:grid-cols-3">
            {loadedTournaments.map((tournament) => (
              <div
                key={tournament.id}
                className="border-2 border-blue-800 shadow-lg rounded-md p-4 hover:border-blue-800 hover:-translate-y-1 ease-in-out duration-300"
              >
